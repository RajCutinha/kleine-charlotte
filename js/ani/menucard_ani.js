(() => {
  ...
  var cardTime = gsapWithCSS.timeline({
    scrollTrigger: {
      trigger: ".card",
      scrub: true,
      start: "top 130%",
  ...
  cardTime.fromTo(".card h4", { opacity: 0 }, { opacity: 1, stagger: 3 }).fromTo(".dish", { opacity: 0, color: "green" }, { opacity: 1, color: "red", stagger: 1 });
})();
/*!
 * CSSPlugin 3.9.1
 * https://greensock.com
