(() => {
  ...
  // ani/speisekarte.js
  var gridTl = gsapWithCSS.timeline({ defaults: { duration: 0.3 } });
  var gridChilds = document.querySelectorAll(".karte-grid a");
  gridTl.fromTo(".menu-section h1", { opacity: 0 }, { opacity: 1, ease: Power4.easeInOut, duration: 0.5 });
  gridChilds.forEach((children) => {
    gridTl.set(children, { opacity: 0, scale: 0, transformOrigin: "left" });
    gridTl.fromTo(children, { opacity: 0, scale: 0 }, { opacity: 1, scale: 1, ease: Power4.easeInOut, stagger: 1, duration: 0.5 }, "<");
  });
})();
/*!
 * CSSPlugin 3.9.1
